public class TestEnviroment{
  public static void main(String[] args) {
    ...
    for (expLambda=0.1; expLambda <0.7; expLambda= expLambda + 0.1){
      ...
      System.out.println("1, " + sim2.runSimulation()/expLambda + ", " + expLambda);
      sim2 = new TwoServerSimQueue(1.904,0.096,0.952,expLambda);
      System.out.println("10, " + sim2.runSimulation()/expLambda + ", " + expLambda);
      sim2 = new TwoServerSimQueue(1.952,0.048,0.976,expLambda);
      System.out.println("20, " + sim2.runSimulation()/expLambda + ", " + expLambda);
      sim2 = new TwoServerSimQueue(1.98,0.02,0.99,expLambda);
      System.out.println("50, " + sim2.runSimulation()/expLambda + ", " + expLambda);
    }
  }
}
